...
* @see https://v0.dev/t/kIojnLsuMrI
    ...
    <div className="flex min-h-[100dvh] flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        <section className="container mx-auto py-12 px-4 md:py-24 md:px-6">
          <div className="grid gap-8 md:grid-cols-2 md:gap-16">
            <div className="space-y-4">
              <h1 className="text-5xl font-bold tracking-tighter sm:text-6xl md:text-7xl font-['Playfair_Display', 'serif']">
        ...
        <section id="experience" className="container mx-auto py-12 px-4 md:py-24 md:px-6">
          <div className="space-y-4 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">My Experience</h2>
            <p className="text-muted-foreground">
      ...
      <footer className="bg-muted py-6 text-center text-sm text-muted-foreground">
        <div className="container mx-auto px-4 md:px-6">&copy; 2024 John Doe. All rights reserved.</div>
      </footer>
    </div>
  )
}
