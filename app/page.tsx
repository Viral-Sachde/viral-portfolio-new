          ...
          <div className="grid gap-8  md:gap-16">
            <div className="space-y-4 text-center">
              ...
              <div className="huhu-lala flex items-center text-center gap-4">
                <div className="rounded-full p-2 text-xl  fixed top-[8%] left-[12%] sm:top-[15%] sm:left-[13%]">                <img src="/emoji/1.webp" width={125} height={125} alt="emoji" className="rounded-full h-20 w-20 sm:h-[125px] sm:w-[125px]" />
                </div>
                <div className="rounded-full p-2 text-xl  fixed top-[13%] left-[70%] sm:top-[35%] sm:left-[43%]">  <img src="/emoji/2.webp" width={125} height={125} alt="emoji2" className="rounded-full h-20 w-20 sm:h-[125px] sm:w-[125px]" />
                </div>
                <div className="rounded-full  p-2 text-xl fixed top-[20.3%] right-[29%]  sm:top-[26%] sm:right-[13%]">  <img src="/emoji/3.webp" width={125} height={125} alt="emoji3" className="rounded-full h-28 w-28 sm:h-[125px] sm:w-[125px]" />
                </div>
              </div><br></br><br></br>
